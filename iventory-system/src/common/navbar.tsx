      ...
      <div className="navbar-right">
        ...
        <div className="notification-container">
          <button className="notification-btn">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M13.73 21C13.5542 21.3031 13.3019 21.5547 12.9982 21.7295C12.6946 21.9044 12.3504 21.9965 12 21.9965C11.6496 21.9965 11.3054 21.9044 11.0018 21.7295C10.6981 21.5547 10.4458 21.3031 10.27 21" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            </svg>
        ...
        <div className="quick-actions">
          {hasPermission(user?.role || 'staff', 'sales.create') && (
            <button className="quick-action-btn" title="New Sale">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
          ...
          {hasPermission(user?.role || 'staff', 'products.create') && (
            <button className="quick-action-btn" title="Add Product">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
